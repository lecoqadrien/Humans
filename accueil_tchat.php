...
<div class="w3-row">
  ...
  <div id = "bloc_gauche_user" class="w3-half w3-container w3-border">

      <div class="w3-text-black">

          <div class="w3-xlarge w3-center w3-teal">USERS</div>
          <br><br>
    ...
    <div id ="bloc_droite_tchat" class="w3-half w3-container w3-white">
          <div class="w3-xlarge w3-center w3-blue">TCHAT</div>
          <br><br>

    <form action="accueil_tchat_post" method="post">
        <p>
        <!--
        ...
        <label for="message">Message</label> :  <input type="text" name="message" id="message" /><br />
        <br>
        <input type="submit" class="w3-blue-grey w3-center" value="Envoyer" />
	  </p>
    </form>
